...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        f_nacimiento = (EditText)findViewById(R.id.edFechaN);
        telefono = (EditText)findViewById(R.id.edTelefono);

        rMasculino = (RadioButton)findViewById(R.id.rbtMasculino);
        rFemenino = (RadioButton)findViewById(R.id.rbtFemenino);
    ...
    public void vistaCalendar(View view)
    {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                f_nacimiento.setText(dayOfMonth + "/" + (month + 1) + "/" + year);
            }
        }, ano, mes, dia);
    ...
    {
        if(nombre.getText().toString() != "" && f_nacimiento.getText().toString() != "" && (rFemenino.isChecked() || rMasculino.isChecked()) && telefono.getText().toString() != "" && telefono.getText().length() == 10)
            Envio();
        else
